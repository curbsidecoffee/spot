    ...
    <div className="z-[1] sticky top-0 shadow-2xl bg-white">
        <nav className="flex justify-between items-center w-[80%] mx-auto h-[8vh]">
            <div className="flex items-center">
                <a className="hidden lg:block transition-all transform hover:scale-[1.2] w-[5vh]" href=""><img src={Logo} alt="LOGO" /></a>
                <a className="transition-all font-[Rubik] text-2xl hover:text-gray-600" href="">curbside coffee.</a>
            </div>
            <div className="">
        ...
        <div className='flex flex-row w-[80%] mx-auto items-center justify-center h-dvh gap-[10vh] hidden lg:flex'>
            ...
            <div className='flex flex-col w-[80%] mx-auto justify-center h-dvh gap-[2vh] hidden lg:flex'>
                <div className='font-[rubik] text-start text-4xl mt-4'>
                  ...
                  <a href="https://www.linkedin.com/in/paolo-juan-saturnino-9abbbb226/">Website by <div className='font-[rubik] '>Paolo Juan Saturnino</div></a>
                  </div>
            </div>
          </div>
            {/*Desktop */}
